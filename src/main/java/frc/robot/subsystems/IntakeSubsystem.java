...
public class IntakeSubsystem extends SubsystemBase {
  ...
  private final SparkMax intakeSparkMax = new SparkMax(16, MotorType.kBrushless);
  ...
  public IntakeSubsystem() {
    ...
    intakeConfig.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder).pid(0.3, 0, 0); 
    intakeConfig.encoder.positionConversionFactor(1);//(360.0/(60.0));
    intakeConfig.encoder.velocityConversionFactor(1); //(360.0/(60.0*10));
    ...
    mIntakeEncoder = intakeSparkMax.getEncoder();
    mIntakeEncoder.setPosition(0);
    mIntakePID = intakeSparkMax.getClosedLoopController();
  }
  ...
  public void periodic() {
    ...
    //    // return this.startEnd(() -> intakeSparkMax.set(0.5), () -> intakeSparkMax.set(0));
